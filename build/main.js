...
},{"./host":4,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
},{"./ajax":2,"./host":4}],4:[function(require,module,exports){
'use strict';
...
var M = {
  init: function init() {
    ...
    $("#logout").click(function () {
      ajax.get(host + 'logout', function (response) {
    ...
    value: function init() {
      $("#validateModal").click(function () {
        ...
        if (!url.match(regex) || url == "") {
          ...
          ajax.post(host + "subscribe", { url: url }, function (response) {
